...
class Faq extends React.Component {
    ...
    render() {
        return (
            <div>
                <Leiste subpage={this.props.subpage}  main_page={"gray"} faq={"black"} information={"gray"}  style={{"position":"relative"}}/>
                ...
                <div className="container main_page_text">
                    ...
                    *Bitte haben Sie Verständnis, dass wir nicht jede Anfrage beantworten können.
                    ...
                    <div className="panel">
                        <br/>
                        <br/>
                        <h2 style={{fontWeight: "bold"}}> PCR-Test</h2>
                        <br/>
                        Der PCR-Test gilt als das zuverlässigste Verfahren, um einen Verdacht auf
                        eine
                        Infektion mit SARS-CoV-2 abzuklären. Der Test wird durch medizinisches
                        Personal
                        entnommen und die Auswertung erfolgt im Labor. Das Ergebnis in der Regel
                        innerhalb von 24 Stunden vor.
                        <br/>
                        <br/>
                        Ablauf: Für den PCR-Test wird in der Regel eine Probe (in der Regel
                        ein
                        Abstrich) aus den Schleimhäuten der Atemwege entnommen. Der Abstrich
                        erfolgt aus dem Mund- und/oder aus dem Nasen-Rachenraum. Weiterhin
                        können Proben durch Hustenauswurf, Spülungen oder die Entnahme von
                        Sekret aus der Luftröhre gewonnen werden. Welche Methode der
                        Probenentnahme im Einzelfall gewählt wird, entscheidet die
                        medizinische
                        Fachperson.
                        Anschließend wird die Probe mit dem PCR-Verfahren in einem Labor
                        analysiert. Mit dem Verfahren der PCR wird Erbmaterial des Virus
                        stark
                        vervielfältigt, sodass es auch in geringen Mengen nachgewiesen
                        werden
                        kann. Das Ergebnis wird in der Regel innerhalb von 24 Stunden
                        ausgewertet und übermittelt.
                        <br/>
                        <br/>
                        Ein positiver PCR-Test stellt eine gesicherte Diagnose für
                        eine
                        Infektion mit dem Coronavirus SARS-CoV-2 dar.
                        <br/>
                        <br/>
                        Quelle:
                        <a target="_blank"
                           href="https://www.infektionsschutz.de/coronavirus/tests-auf-sars-cov-2/">www.infektionsschutz.de/</a>
                        <br/>
                        <br/>

                        <br/>
                        <h2 style={{fontWeight: "bold"}}> Antigen-Schnelltest </h2>
                        <br/>
                        Der Test wird durch geschultes Personal entnommen. Die Auswertung der Testergebnisse erfolgt vor
                        Ort in der Regel innerhalb von 15 bis 30 Minuten.
                        <br/>
                        <br/>
                        Ablauf: Beim Antigen-Schnelltest wird von geschulten Personen eine Probe aus den Schleimhäuten
                        der Atemwege entnommen. Der Abstrich erfolgt aus dem Mund- und/oder aus dem Nasen-Rachenraum.
                        Die Probe wird anschließend auf einen Teststreifen gegeben, der innerhalb von 15 bis 30
                        ...
                        <br/>
                        <br/>
                        <h2 style={{fontWeight: "bold"}}> Antigen-Selbsttest</h2>
                        <br/>
                        ...
                        Nasenbereich. Darüber hinaus kann das Probenmaterial durch Spucken, Gurgeln oder
                        Lutschen gewonnen werden. Die genaue Durchführung der Selbsttests variiert mit der Testart
                        und ist in den beiliegenden Anleitungen beschrieben. Wie auch beim Antigen-Schnelltest liegt das
                        ...
                        unverzüglich mit dem Hausarzt oder einem geeigneten Testzentrum in
                        Verbindung setzen, um das Ergebnis zu überprüfen.
                        <br/>
                        <br/>
                        Quelle:
                        <a target="_blank"
                        ...
                        <br/>
                        <br/>
                        <h2 style={{fontWeight: "bold"}}> Antikörpertest</h2>
                        <br/>
                        Beim Antikörper-Test werden spezifische Antikörper (Eiweiße) im Blut bzw. Serum nachgewiesen.
                        Die Blutprobe wird durch medizinisches Personal entnommen und die Auswertung erfolgt im Labor.
                        <br/>
                        <br/>
                        Anders als bei den anderen Testverfahren kann der Antikörpertest auch eine durchgemachte
                        Infektion nachweisen, denn die Antikörper entwickeln sich in der Regel ein bis zwei Wochen nach
                        der Infektion. Jedoch nimmt die Menge der Antikörper insbesondere bei Personen mit einem milden
                        Verlauf im Laufe der Zeit ab.
                        <br/>
                        <br/>
                        Quelle:
                        <a target="_blank"
                           href="https://www.impfen-info.de/mediathek/fragen-antworten/?tx_sschfaqtool_pi1%5Baction%5D=list&tx_sschfaqtool_pi1%5Bcontroller%5D=FAQ&tx_sschfaqtool_pi1%5Bfaq%5D=4695&cHash=bf633a8342fd6d9561b3ef32d84b8d18">BZgA</a>
                        <br/>
                        <br/>
                        Ein positiver Antikörpertest gilt als Nachweis für eine durchgemachte Infektion mit dem
                        Coronavirus SARS-CoV-2, lässt jedoch keine eindeutige Aussage zur Infektiosität und den Zeitpunkt der
                        Infektion zu.
                        <br/>
                        <br/>
                        Quelle:
                    ...
                    <div className="panel">
                        <br/>
                        Personen, die eine bestätigte Infektion mit dem Coronavirus SARS-CoV-2 durchgemacht
                        haben, haben einen Anspruch auf ein Genesenenzertifikat. Voraussetzung ist der
                        Nachweis
                        eines positiven PCR-Test-Ergebnisses. Der Befund darf maximal sechs Monate alt sein
                        und
                        muss mindestens 28 Tage zurückliegen.
                        <br/>
                        <br/>
                        Sowohl Genesenenzertifikate als auch Genesenenimpfzertifikate können
                        grundsätzlich in Apotheken, Arztpraxen und Impfzentren ausgestellt werden.
                        Die
                        Anbieter können jedoch frei entscheiden, ob sie diesen Service anbieten
                        wollen.
                        Die Zertifikate werden verfügen über einen QR-Code, der in der CovPass-App
                        oder
                        Corona-Warn-App hinterlegt werden kann.
                        <br/>
                        <br/>
                        Quelle:
                        <a target="_blank"
                           href="https://www.bundesgesundheitsministerium.de/coronavirus/faq-covid-19-impfung/faq-digitaler-impfnachweis.html#c21726">Bundesgesundheitsministerium</a>
                        <br/>
                        <br/>
                    </div>
            ...
            </div> <Footer subpage={this.props.subpage} /></div>
        )
    }
}
